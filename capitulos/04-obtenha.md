...
![Texto estruturado em CSV, que será exibido como uma tabela, se aberto em um editor de planilha com o separador de campo adequado](images/obtenha/exemplocsv-2.png)
...
Na Escola de Dados, você encontra [um tutorial de como utilizá-lo para](https://escoladedados.org/tutoriais/geocodificando-enderecos-transforme-tabelas-em-mapas/) [geolocalizar](https://escoladedados.org/tutoriais/geocodificando-enderecos-transforme-tabelas-em-mapas/) as coordenadas de latitude e longitude de endereços em texto, utilizando a API do OpenStreetMaps, por exemplo. Porém, no geral, quando utilizamos a API, é mais comum que ela seja acessada usando algum script.
